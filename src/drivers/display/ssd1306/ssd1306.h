...
#define SSD1306_SET_COL_START(a) \
    ...
    SSD1306_CMD_SET_COL_START_HI | ((((uint8_t)a) >> 4) & 0x0F)
#define SSD1306_SET_PAGE_START(a) SSD1306_CMD_SET_PAGE_START | ((uint8_t)a)
#define SSD1306_SET_START_LINE(a) SSD1306_CMD_SET_START_LINE | ((uint8_t)a)
#define SSD1306_SET_MULTIPLEX(a) SSD1306_CMD_SET_MULTIPLEX, ((uint8_t)a)
#define SSD1306_SET_DISPLAY_OFFSET(a) SSD1306_CMD_SET_DISPLAY_OFFSET, ((uint8_t)a)
#define SSD1306_SET_COM_CONFIG(a) SSD1306_CMD_SET_COM_CONFIG, ((uint8_t)a)
#define SSD1306_SET_CLOCK_DIVIDE(a) SSD1306_CMD_SET_CLOCK_DIVIDE, ((uint8_t)a)
#define SSD1306_SET_PRECHARGE(a) SSD1306_CMD_SET_PRECHARGE, ((uint8_t)a)
#define SSD1306_SET_VCOMM_DESELECT(a) SSD1306_CMD_SET_VCOMM_DESELECT, ((uint8_t)a)
#define SSD1306_SET_CHARGE_PUMP(v) SSD1306_CMD_SET_CHARGE_PUMP, ((uint8_t)v)
